...
\input{sections/frontmatter/00_frontmatter}
\input{sections/frontmatter/01_introduction}
\input{sections/frontmatter/02_canonical_structure}
\input{sections/frontmatter/03_trilogy_overview}
\input{sections/04_vol1}
\input{sections/05_vol2}
\input{sections/06_vol3}
\input{sections/07_conclusion}zzzzzzzzzzzzzz
